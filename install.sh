...
echo 'alias coolchain="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/coolchainio/core.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/coolchainio/core.git'"
...
rm -rf "$HOME/.config/@coolchain"
rm -rf "$HOME/.config/@coolchain"
rm -rf "$HOME/.config/coolchain-core"
